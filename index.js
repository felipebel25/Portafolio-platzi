...
function validateForm(e) {
  ...
  if(nameField.value === ""){
    document.getElementById("name-error").innerHTML= '!Para enviar el formulario necesita el nombre.'
  }else{
    showNotification();
  }
}
...
function showNotification() {
  ...
  document.querySelector('.notification').innerHTML = 'El formalurio fue enviado sin problemas tkm';
  setTimeout(function() {
